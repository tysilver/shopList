	...
	userFactory.getCurrentUser(function (data){
        ...
        if (!$scope.current_user.hasOwnProperty("created_at")) {
        	...
        	userFactory.getUsers(function (data1) {
        		console.log("Here's what we got back after the callback was called: ")
        		console.log(data1)
        		console.log("The scope current_user's users are: ")
        		console.log($scope.current_user.users)
				for (var i = 0; i < data1.length; i++) {
					console.log("We entered the for loop")
					console.log(data1[i])
